...
class PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
 ...
 private:
  ...
  void CircularPlateSource(G4int tot,G4int num,G4double Radius,G4double PSPos[],void (*Process)(float[],float[],G4Event*,G4ParticleGun*,char,char),G4Event* anEvent, char misc, char gamma);
  ...
  static void Cobalt60(float ConstituentPos[],float ConstituentDir[],G4Event* anEvent,G4ParticleGun*PG,char misc,char gamma);
