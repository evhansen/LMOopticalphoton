...
//
//
/// \file LightDetectorSD.hh
/// \brief Definition of the LightDetectorSD class
...
/// LightDetector sensitive detector class
///
/// In Initialize(), it creates one hit for each LightDetector layer and one more
