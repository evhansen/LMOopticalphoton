...
: G4UserRunAction()
{
	...
	analysisManager->CreateNtupleFColumn("iEnergy"); 
	analysisManager->CreateNtupleFColumn("fEnergy"); 
	...
	analysisManager->CreateNtupleFColumn("xfPosh"); 
	analysisManager->CreateNtupleFColumn("yfPosh"); 
	analysisManager->CreateNtupleFColumn("zfPosh"); 
