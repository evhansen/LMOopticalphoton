...
void G4Scintillation::Initialise()
{
  ...
  << "Track Secondaries First: " << params->GetScintTrackSecondariesFirst()
  << "\nFinite Rise Time: " << params->GetScintFiniteRiseTime()
  << "\nScintillation Yield Factor: " << params->GetScintYieldFactor()
  << "\nScintillation Excitation Ratio: " << params->GetScintExcitationRatio()
  << "\nScintillation by Particle Type: " << params->GetScintByParticleType()
  << "\nEnhanced Time Constants: " << params->GetScintEnhancedTimeConstants()
  << "\nStack Photons: " << params->GetScintStackPhotons()
  << "\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n" << G4endl;
#endif
}
...
// evenly along the track segment and uniformly into 4pi.
{
...
#if a
      G4cout << "\n\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n"
      << "NO SCINTILLATION COMPONENTS SPECIFIED; QUIT EARLY\n"
      << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n" 

      << "kSCINTILLATIONCOMPONENT1: " << kSCINTILLATIONCOMPONENT1
      << "\nMPT->GetProp: " << MPT->GetProperty(kSCINTILLATIONCOMPONENT1)
      << "\n\n"
      << G4endl;
#endif
...
#if a
      G4cout << "\n\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n"
      << "NOT FAST OR SLOW COMPONENTS; QUIT EARLY\n"
      << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n\n" << G4endl;
#endif
      return G4VRestDiscreteProcess::PostStepDoIt(aTrack, aStep);
    }
  ...
  {
#if a
    G4cout << "ENHANCED TIME CONSTANTS\n" << G4endl; 
#endif
    if(fScintillationByParticleType)
    {
    ...
    else
    {
      ...
      // by particle type are physically mutually exclusive
#if a
      G4cout << "fYieldFactor: " << fYieldFactor
      << "\nkSCINTY: " << MPT->GetConstProperty(kSCINTILLATIONYIELD) * fYieldFactor
      << "\nMeanNumberOfPhotons: " << MeanNumberOfPhotons
      << "\n\n" << G4endl;
#endif
      if(fEmSaturation){
#if a
	G4cout << "fEMSATURATION\n" 
	<< "VisibleEnergyDep: " << fEmSaturation->VisibleEnergyDepositionAtAStep(&aStep) 
	<< "\n\n" << G4endl;
#endif 
...
#if a
	G4cout << "NOT fEMSATURATION\n" 
	<< "TotalEnergyDep: " << TotalEnergyDeposit
	<< "\n\n" << G4endl;
#endif
